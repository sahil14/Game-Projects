...
def alphaBeta(boardState,depth, alpha, beta, isSoldierMove):
    global cutoffDepth
    ...
    if isSoldierMove:
        ...
        for i in range(length):
            ...
            alphaBetaValue = alphaBeta(boardState,depth-1, alpha, beta, False)
        ...
        # Making it to choose defeat at greater depth 
           ...
           cutoffDepth = 1
           return alphaBeta(boardState,cutoffDepth, -infinity, infinity, True)
        ...
        for i in range(length):
            ...
            v = min(v, alphaBeta(boardState,depth-1, alpha, beta, True))
